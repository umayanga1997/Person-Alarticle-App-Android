...
import com.openlab.personalarticle.Models.UserModel;

import java.util.HashMap;

public class LoginActivity extends AppCompatActivity {

    RelativeLayout google_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(firebaseUser != null){
            ...
            GoogleSignInOptions gop = new GoogleSignInOptions.Builder(GoogleSignInOptions
                    .DEFAULT_SIGN_IN)
            ...
            // Button event
            google_btn.setOnClickListener(v -> login());
        }
    }
                    ...
                    database.getReference().child("Users").child(user.getUid())
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.getKey() != null){
                                snapshot.getRef().updateChildren(userData)
                                ...
                                snapshot.getRef().setValue(userData)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        navigate();
